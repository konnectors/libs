How to contribute to Cozy Konnector Libs?
=========================================
...
- What is the version of the Cozy Konnector Libs?
...
```
$ git clone github.com/cozy/cozy-konnector-libs.git
$ cd cozy-konnector-libs
$ git remote add fork git://github.com/yourusername/cozy-konnector-libs.git
```
...
Go to https://github.com/yourusername/cozy-konnector-libs and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy Konnector Libs is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-konnector-libs/issues/new
...
[localization]: https://github.com/cozy/cozy-konnector-libs/blob/master/README.md#localization
