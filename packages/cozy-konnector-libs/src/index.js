...
module.exports = {
  ...
  saveBills: deprecate(require('./libs/saveDocuments'), 'Use saveDocuments now. saveBills will be removed in cozy-konnector-libs@5'),
  saveDocuments: require('./libs/saveDocuments'),
